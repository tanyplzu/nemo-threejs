...
[Threejs_rubik](https://github.com/newbieYoung/Threejs_rubik)

<!-- <code src="./demo6/game.js" /> -->
...
export default class Main {
  ...
  rotateRubik() {
    ...
    var anotherIndex =
      cubeIndex -
      this.targetRubik.minCubeIndex +
      this.anotherRubik.minCubeIndex;
  ...
  rotateView() {
    ...
    if (this.startPoint.y < this.touchLine.screenRect.top) {
      ...
      this.startPoint.y >
      this.touchLine.screenRect.top + this.touchLine.screenRect.height
    ) {
